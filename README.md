![다운로드](https://user-images.githubusercontent.com/87056402/131690961-e0f6c950-c394-4bcd-9274-f07910b9c50b.png)
...
1. 고객이 객실을 선택하여 예약한다
1. 고객이 결제한다
1. 예약이 되면 내역이 호텔 매니저에게 전달된다
1. 호텔 매니저가 예약을 최종 승인/거절 한다
1. 호텔 매니저가 거절하면 예약이 취소된다.(결제도 취소)
1. 고객이 예약을 취소할수 있다
1. 고객이 예약 상태를 중간중간 조회한다.
1. 예약 상태가 변경될때 마다 카톡으로 고객에게 알림이 간다.
...
1. 성능
    1. 고객이 자주 호텔관리에서 확인할 수 있는 예약상태를 예약시스템(프론트엔드)에서 확인할 수 있어야 한다  CQRS
